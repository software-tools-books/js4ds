...
This is called [server-side page generation](#g:server-side-page-generation):
...
the balance shifted toward [client-side page generation](#g:client-side-page-generation).
In this model,
