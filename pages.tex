...
\figpdf{figures/FIXME.png}{The Document Object Model}{f:pages-dom} % the DOM (repeats the HTMLCSS diagram?)
...
\figpdf{figures/FIXME.png}{Sorting and Replacing}{f:pages-sortlist} % diagram showing how the data is transformed
...
\figpdf{figures/FIXME.png}{A Processing Pipeline}{f:pages-pipeline} % replace all of the embedded comments below with a multi-part diagram
