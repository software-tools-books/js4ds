...
\figimg{figures/FIXME.png}{Sorting and Replacing}{f:pages-sortlist} % diagram showing how the data is transformed
...
\figimg{figures/FIXME.png}{A Processing Pipeline}{f:pages-pipeline} % replace all of the embedded comments below with a multi-part diagram
