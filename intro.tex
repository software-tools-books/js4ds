...
\href{https://www.dabeaz.com/}{David Beazley}\index{Beazley, David} thought that ``JavaScript \emph{versus} Data Science''
...
\href{https://www.embl.de}{EMBL}\index{EMBL}. He teaches a lot of courses in computing, organizes
...
children. He co-founded \href{http://carpentries.org}{Software Carpentry}\index{Software Carpentry}, a non-profit
organization that teaches basic computing skills to researchers, and is now part
of the education team at \href{http://rstudio.com}{RStudio}\index{RStudio}. Greg would like to
...
You can find the code for each chapter within our \href{GitHub repository}{https://github.com/software-tools-in-javascript/js4ds}.
Navigate to the \texttt{src} folder in the root directory,
and you will find folders corresponding to each chapters name.
Each of these folders contain the JavaScript code and data needed 
...
using a service like \href{https://runkit.com/}{RunKit}\index{RunKit},
