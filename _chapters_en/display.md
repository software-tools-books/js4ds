...
- [Server-side page generation](../gloss/#server-side-page-generation)
  - HTML generated by the [server](../gloss/#server)
...
- [Client-side page generation](../gloss/#client-side-page-generation)
  - Allows the [client](../gloss/#client) (e.g., the browser) to decide how best to render data
