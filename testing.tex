...
\figpdf{figures/FIXME.png}{Mocha in Action}{f:testing-mocha} % diagram to show where Mocha looks for tests and the describe/it structure of execution.
...
\figpdf{figures/FIXME.png}{Supertest versus Reality}{f:testing-supertest} % diagram of real HTTP versus supertest.
