...
and we've used the \texttt{Node} command to run JavaScript files in the terminal, 
but we have not yet used the node package manager, \texttt{npm}. 
Before we install Parcel, 
we can turn the directory which we've been creating our HTML and JavaScript files into a project
by typing: 
