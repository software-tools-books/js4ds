...
\figpdf{figures/FIXME.png}{Nested Loop Traversal}{f:basics-traversal} % diagram showing outer and inner traversal axes
...
\figpdf{figures/FIXME.png}{Objects in Memory}{f:basics-object-table} % two-column table representation of object.
...
if \texttt{values} has no length -
i.e. it does not consist of multiple entries -
the function returns \texttt{[undefined,undefined]}.
...
\noindent
If that initial check finds that \texttt{values} does have a length -
i.e. \texttt{!values.length} returns \texttt{false} -
the rest of the function is run.
...
\figpdf{figures/FIXME.png}{How Require Works}{f:basics-require} % diagram showing how require works
