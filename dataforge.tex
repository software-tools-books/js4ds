...
FIXME: show pipeline with new dataframe being created
...
FIXME: show another pipeline diagram
...
FIXME: show sorting and sub-sorting as diagram
...
FIXME: diagram showing head, tail, skip, and take
...
FIXME: draw pipeline and data structures
