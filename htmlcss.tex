...
\figpdf{figures/FIXME.png}{HTML as a Tree}{f:htmlcss-tree} % diagram of HTML tree for this simple page
...
\figpdf{figures/FIXME.png}{Pages and Links}{f:htmlcss-links} % diagram showing three pages with relative links and one external page
...
\figpdf{figures/FIXME.png}{CSS Selectors}{f:htmlcss-selectors} % diagram mapping CSS items to HTML elements.
...
\figpdf{figures/FIXME.png}{Bootstrap Layout}{f:htmlcss-bootstrap} % screenshot
