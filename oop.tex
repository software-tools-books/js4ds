...
\figpdf{figures/FIXME.png}{Objects and Classes in Memory}{f:oop-memory} % picture of objects and classes in memory
...
\figpdf{figures/FIXME.png}{Polymorphism}{f:oop-polymorphism} % picture of polymorphic objects
